...
public class GroppingStreamExam {
	...
	public static void main(String[] args) {
		...
		.collect(Collectors.groupingBy(Student :: getMajor, Collectors.counting())); //모든 정보를 다 가지고와라 
