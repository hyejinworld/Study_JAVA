...
class EqualsExam2{
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof EqualsExam2) {
			EqualsExam2 e2 = (EqualsExam2)obj;
			if(stringObject.equals(e2.stringObject));
		}
	...
	public static void main(String args[]){		
		...
		System.out.println("답확인");
		
		if(s1.equals(s2)){ //s1과 s2 문자열 비교 
